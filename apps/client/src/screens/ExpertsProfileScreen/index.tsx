    ...
    <div className="profile-screen">
      ...
      <div className="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          <div className="flex flex-col items-center pb-10">
              ...
              <h5 className="mb-1 text-md font-bold text-gray-900 dark:text-white">{expertsProfile.full_name}</h5>
              {
                customData!=null &&
                <>
                  <span className="text-sm text-gray-700 dark:text-gray-400">{customData.profession}</span>
                  <span className="text-sm text-gray-700 dark:text-gray-400">{customData.description}</span>                 
                </>               
              }
              ...
              <div className="flex mt-4 md:mt-6">
                  ...
                  <Link to={`/providers/${expertsProfile.id}`} style={{"background":"rgb(66 133 244)"}} className="py-2 px-4 ms-2 text-sm font-medium text-white focus:outline-none rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-white focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Get Appintment</Link>
              </div>
          </div>
      </div>    
    </div>
